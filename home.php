    ...
    <main id="main">
      <section id="team" class="team">
        <div class="section-title">
          <h2>Offers</h2>
          <p>Check Offers</p>
          <input type="text" class="form-control ms-5" id="search" placeholder=recherche>
        </div>
        <div class="container d-flex justify-content-center flex-wrap" id="resultSeach" data-aos="fade-up">
